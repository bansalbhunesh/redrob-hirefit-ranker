...
## The pattern
Three learned rerankers (#3, #6, #7) and two learned/feature alternatives (#1, #2) were
...
50%-weight top-10. That rules out the model class under conditions more favorable than the rules
